...
export function ChatComposer({
  ...
  return (
    <div className="bg-background sticky bottom-0 pt-2 pb-4 before:pointer-events-none before:absolute before:inset-x-0 before:-top-6 before:h-6 before:bg-gradient-to-t before:from-background before:to-transparent">
      ...
      <div
        className={cn(
          "rounded-xl border-input bg-card focus-within:border-ring focus-within:ring-ring/25 relative flex items-end gap-2 border p-2 transition-[box-shadow,border-color] focus-within:ring-[3px]",
          disabled && "opacity-60",
        )}
      >
        <Textarea
