...
function MarketingHeader({ showPricing = false }: { showPricing?: boolean }) {
  return (
    <header className="relative mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 sm:px-6 sm:py-5">
      <Link
        href="/"
        aria-label="Tharros home"
        className="focus-visible:ring-sidebar-ring/50 inline-flex min-h-10 items-center rounded-md outline-none focus-visible:ring-[3px]"
      >
