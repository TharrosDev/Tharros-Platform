      ...
      {session ? (
        <div className="flex flex-1 flex-col">
          ...
          <Link
            ...
            className="group bg-primary text-primary-foreground mt-8 block rounded-xl p-5 transition-colors hover:bg-primary/94 "
          >
          ...
          <div className="mt-4 grid gap-3 lg:grid-cols-2 lg:gap-4">
            <Link
              href="/portal/schedule"
              className="group bg-card flex min-h-24 items-center gap-3 rounded-xl border p-4 transition-colors hover:bg-accent/40 lg:items-start lg:p-5"
            >
