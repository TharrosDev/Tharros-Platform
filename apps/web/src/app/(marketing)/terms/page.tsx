    ...
    >
      <section>
        ...
        <p>
          ...
          right to provide to the service. You are responsible for your organization, the people you
          authorize, and the accuracy of the operational rules and data you configure.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          administrators are responsible for granting appropriate access and removing access when it
          is no longer required. You must not attempt to bypass tenant isolation, authorization
      ...
      <section>
        ...
        <p>
          ...
          product are monthly Canadian-dollar prices unless the checkout states otherwise. Taxes can
          be added where applicable. Trial length, included capabilities, usage limits, and
      ...
      <section>
        ...
        <p>
          ...
          reviewing schedules, employment decisions, policy interpretations, and other consequential
      ...
      <section>
        <h2>Your content</h2>
        <p>
          You retain your rights in the business documents, prompts, employee information, and other
          content you submit. You give Tharros permission to process that content only as needed to
          provide, secure, maintain, and improve the service and to meet applicable legal
          obligations.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            probe or exploit accounts, organizations, systems, or data you are not authorized to
            access;
          </li>
          <li>
            misrepresent AI output as independently verified when it has not been reviewed; or
          </li>
          <li>
            use the service in a way that creates unreasonable risk to other users or the platform.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          available billing controls. Data handling after termination follows the privacy notice and
          applicable provider retention requirements.
        </p>
      </section>
